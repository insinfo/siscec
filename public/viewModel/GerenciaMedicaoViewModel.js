...
GerenciaMedicaoViewModel.prototype.init = function () {
    ...
    self.dataTableParcela.setDisplayCols(
        [
            {"key": "id"},
            {
                "key": "idEmpenho",
                ...
                "validation": self.validaInputEmpenho,
                "render": function (tdContent) {
            ...
            },
            {
                ...
                "validation": self.validaInputValorParcela
            }
...
GerenciaMedicaoViewModel.prototype.getMedicoes = function () {
    ...
    self.dataTableListaMedicao.setDisplayCols([
        ...
        {"key":"totalMedicao","render": function (rowData) {
                return '<span class="purple-text darken-1">'+rowData['totalMedicao']+'</span>';
            }}
    ]);
    if (self.disableFeature) {
    ...
    self.dataTableListaMedicao.setDataToSender({"idContrato":self.idContrato});
...
GerenciaMedicaoViewModel.prototype.getContratos = function () {
    var self = this;
    ...
    self.tableListaContrato.on('click', 'tbody tr', function () {
        ...
        self.inputIdContratoMedicao.val(data['numeroContrato'] + '/' + data['anoContrato']);
        self.inputIdContratoMedicao.attr('data-content', data['id']);
...
GerenciaMedicaoViewModel.prototype.saveMedicao = function () {
    ...
    var dataToSender = {
        'idContrato': self.inputIdContratoMedicao.attr('data-content'),
        'dataInicio': self.inputDataInicioMedicao.val(),
        'dataFim': self.inputDataFimMedicao.val(),
        'pago': false
    };

    dataToSender['parcelas'] = self.dataTableParcela.getModifiedData();
...
GerenciaMedicaoViewModel.prototype.eventos = function () {
    ...
    self.inputIdContratoMedicao.click(function () {
        //self.getContratos(self.inputIdContratoMedicao);
    });
