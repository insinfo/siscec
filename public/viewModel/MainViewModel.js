...
MainViewModel.prototype.init = function () {
    ...
    this.menuAPI.setWebServiceURL(this.webserviceSiscecBaseURL+'menu/hierarquia');
    this.menuAPI.setTarget('iframeShowPage');
