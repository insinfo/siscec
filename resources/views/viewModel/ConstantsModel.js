...
var WEBSERVICE_PMRO_BASE_URL = '//jubarte.riodasostras.rj.gov.br/pmroPadrao/';
var WEBSERVICE_SISCEC_BASE_URL = '//jubarte.riodasostras.rj.gov.br/siscec/api/';
...
function getSetorUsuario () {
    return parseInt(sessionStorage.getItem('idSetor'));
}